...
{
  Unidade de cálculos básicos com strings, isto serve para que 
  processadores pequenos (<=16bit) consigam realizar cálculos 
  com números muito grandes (>=64bit).
  Isto é, o cálculo de números não fica dependente da capacidade 
  do processador, mas sim da RAM do computador.
  Os cálculos são feitos com strings, imitando os métodos 
  ancestrais de cálculo.  
}
...
begin
  ...
  // Se houver decimais, remover zeros à direita desnecessários
...
{ --- Operações Internas (Sempre Positivas) --- }
...
{ --- Operações Públicas (Tratamento de Sinais) --- }
